...
43-60 cm <- slow, good for games that focus on highly precise long range or slow strafing situations like tacfps games.
...
The human brain is adaptable, and people are capable of learning things like alternate keyboard layouts in just a few months. Sensitivity is a much smaller change. It's also important to realize that your actual sensitivity isn't a variable you can keep static. Factors like the humidity and temperature of your room, the fov you're using in game, dpi variation between mice, etc, etc, all make your mouse input feel slower or faster than normal. For most people, these things are hardly even noticeable, and it doesn't negatively affect their aim long term. It's not uncommon for people to use a different sensitivity for each game, and they're usually better for it. Even very high level players tend to change their sensitivity to suit a given environment or task. This obviously doesn't hold them back, shown by the fact that they outperform pretty much everyone else.

THIS DOESN'T MEAN YOU SHOULD BE CONSTANTLY CHANGING YOUR SENS IN GAME. While different values are good for different things, it's unlikely that the reason you're performing badly is because you're using 38 cm instead of 36.5. Focus on other issues before you conclude that you need to change your sensitivity. Never change your sensitivity on impulse, it's best to deliberately set a single value and use it rather than impulsively changing your sens every time you become frustrated by poor performance.
