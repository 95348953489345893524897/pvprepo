...
This isn't particularly useful in the case of +zoom since you can just use toggle_zoom, but there are other commands that incrementing aliases can make into toggle commands.<br/>
